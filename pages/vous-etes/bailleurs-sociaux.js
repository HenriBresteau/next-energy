...
const VousEtes = () => (
  <Layout title="Bailleurs Sociaux">
    <Container maxW="container.xl">
      <TitleVE>Bailleurs Sociaux</TitleVE>
    </Container>
    <Box>
    ...
    >
      <Box flex="0.8" maxW={{ md: "600px" }} mr={{ md: "50px" }}>
        ...
        <Text>
          ...
          faire des économies de chauffage, améliorer le confort des locataires
          et entretenir votre patrimoine. <br />
    ...
    >
      ...
      <Box flex="0.8" maxW={{ md: "600px" }} mr={{ md: "50px" }}>
        ...
        <Text>
          Le dispositif des CEE (Certificats d’Économies d’Énergie) a été mis en
          place par le gouvernement pour favoriser les travaux liés à la
    ...
    <Box>
      ...
      <UnorderedList color={"next"} fontWeight="600" pb={6}>
        ...
        <ListItem>
          L’isolation des points singuliers de vos canalisations Vous permettent
          de générer des baisses de charges, d’améliorer le confort des
          habitants et de valoriser votre patrimoine immobilier.
        </ListItem>
      </UnorderedList>
      <Text pb={6}>
      ...
      <Text color={"next"} fontWeight="600" pb={6}>
        NEXT ENERGY met à votre disposition toutes ses compétences pour la mise
        en œuvre des solutions les plus performantes pour vous aider à maîtriser
        votre consommation énergétique et valoriser votre patrimoine immobilier.
      </Text>
    </Box>
  </Layout>
);
